...
pub unsafe trait GCPtr: Sized + Copy {
    ...
    /// Creates [`GCRootInfo`] for a value. This is used for making GC roots. This method is only
    /// overwritten for certain gc primitives.
    ///
    ...
    /// Retrieves an instance of `Self` from a GC pointer generated by [`Self::to_gc_root_entry`].
    /// This method is only overwritten for certain gc primitives.
    ///
